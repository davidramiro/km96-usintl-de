...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
	...
	*/
    [_BASE] = LAYOUT_all(
        ...
        MO(_LOC),KC_A,    KC_S,    KC_D,    KC_F,    KC_G,    KC_H,    KC_J,    KC_K,    KC_L,    KC_SCLN, MC_QUOT,  KC_ENT,                    KC_P4,   KC_P5,   KC_P6,   KC_PPLS,
    ...
    */
    [_LOC] = LAYOUT_all(
        _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______,
        _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, GER_SZ,  _______, KC_DEL,   KC_DEL, _______, _______, _______, _______,
        _______, _______, _______, EU_EUR,  _______, _______, _______, UML_UE,  _______, UML_OE,  _______, UML_UE,  _______, _______,          _______, _______, _______, _______,
